...
Patch3:     spurious.service-fix.patch
...
# << install pre
%make_install
rm -f $RPM_BUILD_ROOT/usr/lib/girepository-1.0/TelepathyGLib-0.12.typelib
rm -f $RPM_BUILD_ROOT/usr/share/gir-1.0/TelepathyGLib-0.12.gir
